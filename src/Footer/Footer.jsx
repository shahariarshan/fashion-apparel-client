...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-lime-100 text-red-600 mt-6">
        <nav>
  ...
  <aside className="items-center grid-flow-col">
    ...
    <p><span  className="text-blue-400 font-bold text-2xl">Fashion House</span> <br/>Providing reliable tech since 1992</p>
  </aside> 
