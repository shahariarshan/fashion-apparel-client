...
const BrandSlider = ({item}) => {
    ...
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full">
          <img  src={item.images1} className="lg:w-full lg:object-cover lg:p-44" />
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img src={item.images2}  className="w-full lg:object-cover lg:p-44" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <img src={item.images3}  className="w-full lg:object-cover lg:p-44" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide2" className="btn btn-circle bg-red-600">❮</a> 
            <a href="#slide1" className="btn btn-circle bg-red-600">❯</a>
          </div>
